            ...
            <DashboardLayout>
                ...
                <section className="result-section">
                    <div className="result-firstLine">
                        ...
                        <div className="result-firstLine-detail">맥스턴은 코스피 주식을 기반으로, 거래 수수료0, 거래세0, 거래 가격은 당일 종가를 기본으로 설정하고 있습니다.</div>
                ...
                <section className="parameter-section">
                    ...
                    <div className="parameter-detail">맥스턴은 코스피 주식을 기반으로, 거래 수수료0, 거래세0, 거래 가격은 당일 종가를 기본으로 설정하고 있습니다.</div>
