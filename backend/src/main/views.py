...
def explain1(request):
    return render(request, 'main/explain1.html')

def explain2(request):
    return render(request, 'main/explain2.html')

def explain3(request):
    return render(request, 'main/explain3.html')
...
def login(request):
    ...
    if user.user_password == encrypted_loginPW:
        ...
        return HttpResponse('login성공')
        #return redirect('main_index')
    else:
        return HttpResponse('login실패')
        #return redirect('main_loginFail')
