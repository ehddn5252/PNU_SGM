...
class Stretagy(models.Model):
    ...
    u_per_e = models.IntegerField(verbose_name="주가수익배수(max)", blank=True)
    u_pbr_s = models.IntegerField(verbose_name="주가순자산배수(min)", blank=True)
    u_pbr_e = models.IntegerField(verbose_name="주가순자산배수(max)", blank=True)
    u_pcr_s = models.IntegerField(verbose_name="주가현금흐름배수(min)", blank=True)
    u_pcr_e = models.IntegerField(verbose_name="주가현금흐름배수(max)", blank=True)
    u_psr_s = models.IntegerField(verbose_name="주가매출액배수(min)", blank=True)
    u_psr_e = models.IntegerField(verbose_name="주가매출액배수(max)", blank=True)
